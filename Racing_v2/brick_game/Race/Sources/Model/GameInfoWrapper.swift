...
public enum UserAction: UInt16 {
    ...
    public static func fromInput(_ rawValue: UInt32?) -> UserAction? {
    ...
    public static func == (lhs: UserAction, rhs: UserAction_t) -> Bool {
        return lhs.toCAction() == rhs
    }

    public static func == (lhs: UserAction_t, rhs: UserAction) -> Bool {
        return rhs.toCAction() == lhs
    }
    
    public func toCAction() -> UserAction_t {
        switch self {
        case .start:
            return Start
        case .pause:
    ...
    public static func fromCAction(_ action: UserAction_t?) -> UserAction? {
        switch action {
        case Start:
            return .start
        case Pause:
