...
//    private var _racingFSM: PREV_FinalStateMachine
...
//    
//    /// - Note: **Заглушка**
//    init(_collisionHandler: PREV_CollisionCheckable, _lvlManager: PREV_LevelManager, _racingFSM: PREV_FinalStateMachine, _spawner: PREV_EnemySpawner, _racingModel: PREV_RacingModel) {
//       
