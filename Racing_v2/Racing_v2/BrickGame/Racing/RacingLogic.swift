...
//    }
    ...
    /// - Note: **Заглушка**
    init(_collisionHandler: PREV_CollisionCheckable, _lvlManager: PREV_LevelManager, _racingFSM: FinalStateMachine, _spawner: PREV_EnemySpawner, _racingModel: RacingModel) {
